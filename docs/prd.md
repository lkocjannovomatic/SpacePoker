...
- Conversation History: The chat window includes a "History" tab that displays a summary of all recent conversations against that specific NPC, optimized for LLM context prompting.
...
- Acceptance Criteria:
    ...
    - Then the view switches to show a text block containing a summary of all recent conversations against this NPC.
